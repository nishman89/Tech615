...
//        System.out.println(x == y);
        ...
        Person p2 = new Person("Bob", "Smith", 25);
        Person p3 = new Person("Alice", "Smith", 22); // same names, different age
        Person p4 = new Person("Zara", "Adams", 40);

        List<Person> people = new ArrayList<>(of(p1, p2, p3, p4));
        Collections.sort(people);
        System.out.println("Sorted by last name, first name, age:");
